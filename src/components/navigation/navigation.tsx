...
const Navigation = () => {
	...
	return (
		<div className='flex items-center justify-around pt-4 pb-2 bg-white shadow-[0px_-1px_48px_0px_#00000024] sticky bottom-0 w-full'>
			{navItems.map((item, index) => {
				...
				return (
					<Link
						...
						to={item.path}
						className={cn(
							'relative text-center flex flex-1 flex-col items-center',
							activeLink &&
